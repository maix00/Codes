...
local_data_provider = local_data_provider_adjusted(ticker_names=ticker_names)
print("End loading data ...")
session_builder.set_data_provider(local_data_provider)
...
# l1_1 = local_data_provider.historical_price(ChinaFutures("BC.INE"), PriceField.Close, 85, datetime(2025, 7, 25, 10, 37))
# l1_2 = local_data_provider.get_history(ChinaFutures("BC.INE"), ["adjustment_mul", "adjustment_add", "close_price", "close_price_adjusted", "volume", "DATA_ISSUE", "DATA_ISSUE_SOLUTION"], datetime(2025, 1, 22, 14, 39), datetime(2025, 1, 22, 14, 45))
